                    ...
                    shape: const StadiumBorder(), onPressed: () async {
                      ...
                      if (cancerType == "Lung Cancer") {
                        ...
                        prognosisBody = {
                          ...
                          "AirPollution": (int.parse(textFieldControllers[2].text)/10)*8 ,
                          "Alcoholuse": (int.parse(textFieldControllers[3].text)/10)*8,
                          "DustAllergy": (int.parse(textFieldControllers[4].text)/10)*8,
                          "OccuPationalHazards": (int.parse(textFieldControllers[5].text)/10)*8,
                          "GeneticRisk": (int.parse(textFieldControllers[6].text)/10)*7,
                          "chronicLungDisease": (int.parse(textFieldControllers[7].text)/10)*7,
                          "BalancedDiet": (int.parse(textFieldControllers[8].text)/10)*7,
                          "Obesity": (int.parse(textFieldControllers[9].text)/10)*7,
                          "Smoking": (int.parse(textFieldControllers[10].text)/10)*8,
                          "PassiveSmoker": (int.parse(textFieldControllers[11].text)/10)*8,
                          "ChestPain": (int.parse(textFieldControllers[12].text)/10)*9,
                          "CoughingofBlood": (int.parse(textFieldControllers[13].text)/10)*9,
                          "Fatigue": (int.parse(textFieldControllers[14].text)/10)*9,
                          "WeightLoss": (int.parse(textFieldControllers[15].text)/10)*8,
                          "ShortnessofBreath": (int.parse(textFieldControllers[16].text)/10)*9,
                          "Wheezing": (int.parse(textFieldControllers[17].text)/10)*8,
                          "SwallowingDifficulty": (int.parse(textFieldControllers[18].text)/10)*8,
                          "ClubbingofFingerNails": (int.parse(textFieldControllers[19].text)/10)*9,
                          "FrequentCold": (int.parse(textFieldControllers[20].text)/10)*7,
                          "DryCough": (int.parse(textFieldControllers[21].text)/10)*7,
                          "Snoring": (int.parse(textFieldControllers[22].text)/10)*7,
                        };
                      }
                      ...
                      progressDialog.style(
                          ...
                          progressWidget: LinearProgressIndicator(backgroundColor: Colors.lightBlueAccent,),
                          elevation: 10.0,
