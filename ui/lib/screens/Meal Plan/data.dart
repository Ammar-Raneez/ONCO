...
List<Recipe> recipes = [
  ...
  Recipe(
    ...
    steps:
      '1. 1/2 ripe avocado, peeled and pitted\n'
      '\n'
  ...
  Recipe(
    ...
    imageUrl:
    'https://under500calories.com/photos/10057.jpg',
    duration: 'Skin Cancer',
    ingredients:
  ...
  Recipe(
    ...
    imageUrl:
    'https://leaf.nutrisystem.com/wp-content/uploads/2019/11/2-1.jpg',
    duration: 'Breast Cancer',
    ingredients:
    '- 1 vanilla bean\n'
        '- 1 frozen banana\n'
